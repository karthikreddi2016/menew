...
export default function VideoEditingChoosePage() {
  const router = useRouter()
  const [selectedOption, setSelectedOption] = useState('Explainer Video (<60sec)')
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col justify-between">
      ...
      <main className="flex-1 max-w-[1280px] w-full mx-auto px-4 sm:px-8 py-10 sm:py-16 flex flex-col justify-center">
        ...
        {/* White Card Container holding 8 Options */}
        <div className="bg-white rounded-[20px] border border-[#EDEDED] p-6 sm:p-10 shadow-xs max-w-[960px] w-full mx-auto">
          ...
          {/* Next Button aligned to bottom right inside/below the box */}
